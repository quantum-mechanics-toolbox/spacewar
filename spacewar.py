...
def swap_settings(game):
    ...
    if game == '1962':
        for k in keylist:
            settings_2024[k] = settings[k]
            settings[k] = settings_1962[k]
        settings['game'] = '1962'
    if game == '2024':
        for k in keylist:
            settings_1962[k] = settings[k]
            settings[k] = settings_2024[k]
        settings['game'] = '2024'
...
class menu():
    ...
    def enter(self):
        ...
        for control in self.control_items:
...
class menu_item():
    def __init__(self, name, itemtype, parent, game="1962", key="", contents = []):
        self.name = name
...
game_menu_item = menu_item("game_version", "options", "main_menu", "1962", "game", ['1962','2024'])
#game_menu_item.contents = ['1962', '2024']
main_menu.menu_items.append(game_menu_item)
system_menu_item = menu_item("system", "menu", "main_menu", "2024")
...
player_color_menu_item = menu_item("player_display", "menu", "display", "2024")
